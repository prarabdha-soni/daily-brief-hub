...
const DUMMY_ARTICLES = [
  ...
  },
  {
    ...
    subtitle: "The BJP's reduced majority signals a shift in voter expectations — and opposition arithmetic",
  ...
  },
  {
    ...
    subtitle: "After two years of compressed valuations and layoffs, capital is returning — to profitable businesses only",
  ...
  },
  {
    ...
    subtitle: "The captain walked away on his own terms — but Indian cricket's transition at the top has only just begun",
  ...
  },
  {
    ...
    subtitle: "The government's digital public infrastructure model may be the world's most ambitious AI deployment — if governance catches up",
  ...
  },
  {
    ...
    subtitle: "Record registrations, rising ticket sizes and a new buyer profile are rewriting the city's real-estate story",
  ...
  },
  {
    ...
    subtitle: "The political transition in Bangladesh has forced India to rethink a relationship it had taken for granted",
