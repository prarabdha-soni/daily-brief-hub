...
import { listArticlesForAdmin } from "./actions";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        <div className="mb-8 border-b-2 border-foreground pb-3">
          ...
          <p className="mt-1 font-sans text-sm text-muted-foreground">Shared-password access.</p>
        </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 font-sans">
      ...
      <Field label="Cover image URL">
        ...
        />
        {coverUrl && (
          <img src={coverUrl} alt="" className="mt-2 aspect-[16/9] w-full max-w-md object-cover" />
        )}
      </Field>
...
function ArticleManager({ password }: { password: string }) {
  ...
  return (
    <div className="mt-14 border-t-2 border-foreground pt-8 font-sans">
      ...
      {msg && <p className="mb-4 rounded border border-border bg-muted px-3 py-2 text-sm">{msg}</p>}
